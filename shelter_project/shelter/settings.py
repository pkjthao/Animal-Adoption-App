...
SECRET_KEY = "django-insecure-zhvwam@o=qfw^n%nj5uris7-e(qk6o$$+lw8$d$m%fqpat4r$f"
...
STATIC_ROOT = BASE_DIR / "staticfiles"  # This is typically used in production, not necessary in dev mode

# Media files (if you are using user-uploaded files, e.g., animal images)
MEDIA_URL = '/media/'

MEDIA_ROOT = BASE_DIR / 'media'  # This is where your uploaded media will be stored
