...
user_val = input("Enter the mph of the new plane")
# 500); DROP TABLE plane;

# insert some data into the plane table (tailno, make, model, capacity, mph)
# execute to run a single SQL statement
cur.execute("INSERT INTO plane VALUES ('101', 'Boeing', '757', 200, " + user_val + ")")
